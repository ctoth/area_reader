...
class SMAUG_ACT_TYPES(enum.IntFlag):
    IS_NPC = 1 << 0
    SENTINEL = 1 << 1
    SCAVENGER = 1 << 2
    NOLOCATE = 1 << 3
...
SMAUG_TRAP_TYPES = enum.Enum(
    "SMAUG_TRAP_TYPES",
    "POISON_DART POISON_NEEDLE POISON_DAGGER POISON_ARROW BLINDNESS_GAS SLEEPING_GAS FLAME EXPLOSION ACID_SPRAY ELECTRIC_SHOCK BLADE SEX_CHANGE",
)
