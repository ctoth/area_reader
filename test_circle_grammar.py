...
$""",
    ...
    reader = area_reader.dialects.circle.CircleAreaFile(root)
...
@pytest.mark.parametrize(
    ("locks", "expected"),
    [
        (0, constants.EXIT_FLAGS.NONE),
        (1, constants.EXIT_FLAGS.ISDOOR),
        (
            2,
            constants.EXIT_FLAGS.ISDOOR | constants.EXIT_FLAGS.PICKPROOF,
        ),
    ],
)
