...
from area_reader.native import render_record


def circle_reader_with_data(text: str) -> area_reader.dialects.circle.CircleAreaFile:
    reader = area_reader.dialects.circle.CircleAreaFile("unused")
...
def test_circle_zone_reset_arity_matches_db_loader(
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        reader = area_reader.dialects.circle.CircleAreaFile(directory)
...
def test_circle_mobile_native_transform_is_bijective(
    ...
    reader = circle_reader_with_data(render_record(mob))
