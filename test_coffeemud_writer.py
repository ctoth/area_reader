...
def load_coffeemud(path: Path) -> area_reader.dialects.coffeemud.CoffeeMudAreaFile:
    area_file = area_reader.dialects.coffeemud.CoffeeMudAreaFile(path)
...
) -> area_reader.dialects.coffeemud.CoffeeMudAreaFile:
    path = tmp_path / name
...
def test_coffeemud_native_normalization_ledger_is_explicit() -> None:
    assert area_reader.dialects.coffeemud.CoffeeMudAreaFile.NATIVE_NORMALIZATIONS == (
